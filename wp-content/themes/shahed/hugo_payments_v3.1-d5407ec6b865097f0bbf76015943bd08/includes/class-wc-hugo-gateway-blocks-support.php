...
final class WC_Hugo_Gateway_Blocks_Support extends AbstractPaymentMethodType {

    private $gateway;

    protected $name = 'hugo'; // payment gateway id
    ...
    public function get_payment_method_script_handles() {
        ...
        return array( 'wc-hugo-blocks-integration' );
