    ...
    <div class="slider relative flex w-full" >
        <div class="relative w-full slider-slide" style="min-width:1910px;max-width:1910px;transform:translate3d(0px,0px,0px)">
            ...
            <div class="absolute z-20 flex w-full flex-col items-center text-center ltr:leading-en rtl:leading-ar bottom-[-67px] font-sans md:vw-bottom-[60] xl:vw-bottom-[150]">
                <div class="px-4 md:px-0 md:vw-w-[554] lg:vw-w-[714] text-[22px] font-black text-white md:vw-text-[28] xl:vw-text-[36]">اكتشف المزيد مع اشتراك شاهد الخاص بك!</div>
                <div class="mt-[8px] px-[16px] font-medium text-light-blue-2 md:px-0 md:vw-w-[554] lg:vw-w-[714] text-[14px] md:vw-text-[20] xl:vw-text-[24]">أعمال شاهد الأصلية، مسلسلات حصرية، عروض أولية لأحدث الأفلام، وإثارة القنوات المباشرة. منصتك للترفيه الشامل والمزيد.</div>
            </div>
